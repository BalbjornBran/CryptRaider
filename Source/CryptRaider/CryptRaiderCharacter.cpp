...
{	
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		//Interacting
		//EnhancedInputComponent->BindAction(InteractAction, ETriggerEvent::Triggered, this, &ACryptRaiderCharacter::Interact);
		//Releasing
		//EnhancedInputComponent->BindAction(InteractAction, ETriggerEvent::Completed, this, &ACryptRaiderCharacter::StopInteract);
	}
	else
	{
...
/*
void ACryptRaiderCharacter::Interact(const FInputActionValue& Value)
{
	GEngine->AddOnScreenDebugMessage(-1, 0.2f, FColor::Red, "Interacting");
}

void ACryptRaiderCharacter::StopInteract(const FInputActionValue& Value)
{
	GEngine->AddOnScreenDebugMessage(-1, 5.f, FColor::Red, "StopInteracting");
}
*/
